    ...
    <footer
        ...
        <div class="flex flex-col items-center gap-2">
            ...
            <div class="flex items-center justify-center">
                ...
                >
                <!-- <div class="hidden sm:block h-3 w-px bg-border ml-1 mr-1"></div>
                <a
                    href="https://beian.mps.gov.cn/#/query/webSearch?code=31011202022083"
                    rel="noopener noreferrer"
                    target="_blank"
                    class="group flex items-center justify-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors rounded-full border border-transparent px-3 py-1.5 hover:bg-card/50"
                    ><img
                        ...
                        alt="" /><span>沪公网安备31011202022083号</span></a
                > -->
            </div>
        </div>
    </footer>
